<template>
    <b-modal :id="'insert-link'" hide-footer centered title="Nuevo Enlace">
        <form class="row g-3" @submit="createText" @submit.prevent>
            <div class="modal-body">
                ...
                <div class="input-group  mb-2">
                    ...
                    <textarea class="form-control" name="textarea" rows="5" cols="35" v-model="form.content" required></textarea>
                </div>
            ...
            <div class="modal-footer">
                <button @click="$bvModal.hide('insert-link')" class="btn btn-secundary">
                    Cerrar
                </button>

<template>
    <b-modal :id="'insert-text'" hide-footer centered title="Nuevo Texto">
        <form class="row g-3" @submit="createText" @submit.prevent>
            ...
            <div class="modal-footer">
                <button @click="$bvModal.hide('insert-text')" class="btn btn-secundary">
                    Cerrar
                </button>
